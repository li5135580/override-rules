...
============================================================
  🔴 多订阅聚合占位符 - 在本地代理客户端搜索替换即可
============================================================
  P1 占位符: https://www.baidu.com  →  替换为你的订阅链接1
  P2 占位符: https://www.google.com →  替换为你的订阅链接2
============================================================
...
(() => {
  ...
  var proxyProviders, PROXY_PROVIDER_NAMES;
  var init_proxy_providers = __esm({
    "src/proxy_providers.ts"() {
      "use strict";
      proxyProviders = {
        P1: {
    ...
    "src/main.ts"() {
      ...
      function main(config) {
        ...
        for (const group of proxyGroups) {
          ...
          if (name === PROXY_GROUPS.SELECT || name === PROXY_GROUPS.MANUAL || name === PROXY_GROUPS.AUTO || name === PROXY_GROUPS.FALLBACK || name === PROXY_GROUPS.LOW_COST || name.endsWith(NODE_SUFFIX)) {
